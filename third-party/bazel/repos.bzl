...
def everest_core_repos():
    ...
    maybe(
        ...
        url = "https://github.com/dorezyuk/everest-framework/archive/28ebfd9338c6272473f45e5b16845aba58f58d28.tar.gz",
        strip_prefix = "everest-framework-28ebfd9338c6272473f45e5b16845aba58f58d28",
    )